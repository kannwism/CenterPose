...
if __name__ == '__main__':
    ...
    if opt.cam_intrinsic is None:
        meta['camera_matrix'] = np.array(
            # [[663.0287679036459, 0, 300.2775065104167], [0, 663.0287679036459, 395.00066121419275], [0, 0, 1]])  # original
            [[607.45556640625, 0.0, 436.209228515625], [0.0, 607.0517578125, 242.99063110351562], [0, 0, 1]]) # new realsense
            # [[580.1939697265625, 0.0, 320.0010070800781], [0.0, 580.1939697265625, 241.80599975585938], [0, 0, 1]]) # orbbec astra
